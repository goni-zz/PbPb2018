...
for i in `cat expressrunstoprocess` 
do
	python submitForestExpress.py -q cmscaf1nd -o /eos/cms/store/group/phys_heavyions/dileptons/Data2018/PbPb502TeV/TTrees/Express/v${1}/ -i ExpressPhysics.$i.${1}.list --proxy=proxyforprod
done
